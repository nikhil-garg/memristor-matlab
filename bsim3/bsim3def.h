...
#define BSIM3qcheq	12
#define BSIM3cqcheq	13
#define BSIM3qcdump  	14
#define BSIM3cqcdump	15
...
typedef struct sBSIM3instance
{
    ...
    //IFuid BSIM3name;
    SPMatrix *stamp; /* matrix for (C/h+G) */
    SPMatrix *g_stamp; /* matrix for G */
    SPMatrix *c_stamp; /* matrix for C */
    SPMatrix *ec_stamp; /* matrix for extrinsic C */
    ...
    AccessNode *BSIM3DdPtr;
    AccessNode *BSIM3GgPtr;
    AccessNode *BSIM3SsPtr;
    AccessNode *BSIM3BbPtr;
    AccessNode *BSIM3DPdpPtr;
    AccessNode *BSIM3SPspPtr;
    AccessNode *BSIM3DdpPtr;
    AccessNode *BSIM3GbPtr;
    AccessNode *BSIM3GdpPtr;
    AccessNode *BSIM3GspPtr;
    AccessNode *BSIM3SspPtr;
    AccessNode *BSIM3BdpPtr;
    AccessNode *BSIM3BspPtr;
    AccessNode *BSIM3DPspPtr;
    AccessNode *BSIM3DPdPtr;
    AccessNode *BSIM3BgPtr;
    AccessNode *BSIM3DPgPtr;
    AccessNode *BSIM3SPgPtr;
    AccessNode *BSIM3SPsPtr;
    AccessNode *BSIM3DPbPtr;
    AccessNode *BSIM3SPbPtr;
    AccessNode *BSIM3SPdpPtr;

    AccessNode *BSIM3QqPtr;
    AccessNode *BSIM3QdpPtr;
    AccessNode *BSIM3QgPtr;
    AccessNode *BSIM3QspPtr;
    AccessNode *BSIM3QbPtr;
    AccessNode *BSIM3DPqPtr;
    AccessNode *BSIM3GqPtr;
    AccessNode *BSIM3SPqPtr;
    AccessNode *BSIM3BqPtr;

    /* added by Shih-Hung */
    /* quick access to spmatrix node */
    AccessNode *C_BSIM3DdPtr;
    AccessNode *C_BSIM3GgPtr;
    AccessNode *C_BSIM3SsPtr;
    AccessNode *C_BSIM3BbPtr;
    AccessNode *C_BSIM3DPdpPtr;
    AccessNode *C_BSIM3SPspPtr;
    AccessNode *C_BSIM3DdpPtr;
    AccessNode *C_BSIM3GbPtr;
    AccessNode *C_BSIM3GdpPtr;
    AccessNode *C_BSIM3GspPtr;
    AccessNode *C_BSIM3SspPtr;
    AccessNode *C_BSIM3BdpPtr;
    AccessNode *C_BSIM3BspPtr;
    AccessNode *C_BSIM3DPspPtr;
    AccessNode *C_BSIM3DPdPtr;
    AccessNode *C_BSIM3BgPtr;
    AccessNode *C_BSIM3DPgPtr;
    AccessNode *C_BSIM3SPgPtr;
    AccessNode *C_BSIM3SPsPtr;
    AccessNode *C_BSIM3DPbPtr;
    AccessNode *C_BSIM3SPbPtr;
    AccessNode *C_BSIM3SPdpPtr;

    AccessNode *C_BSIM3QqPtr;
    AccessNode *C_BSIM3QdpPtr;
    AccessNode *C_BSIM3QgPtr;
    AccessNode *C_BSIM3QspPtr;
    AccessNode *C_BSIM3QbPtr;
    AccessNode *C_BSIM3DPqPtr;
    AccessNode *C_BSIM3GqPtr;
    AccessNode *C_BSIM3SPqPtr;
    AccessNode *C_BSIM3BqPtr;

    /* quick access to spmatrix node */
    AccessNode *EC_BSIM3DdPtr;
    AccessNode *EC_BSIM3GgPtr;
    AccessNode *EC_BSIM3SsPtr;
    AccessNode *EC_BSIM3BbPtr;
    AccessNode *EC_BSIM3DPdpPtr;
    AccessNode *EC_BSIM3SPspPtr;
    AccessNode *EC_BSIM3DdpPtr;
    AccessNode *EC_BSIM3GbPtr;
    AccessNode *EC_BSIM3GdpPtr;
    AccessNode *EC_BSIM3GspPtr;
    AccessNode *EC_BSIM3SspPtr;
    AccessNode *EC_BSIM3BdpPtr;
    AccessNode *EC_BSIM3BspPtr;
    AccessNode *EC_BSIM3DPspPtr;
    AccessNode *EC_BSIM3DPdPtr;
    AccessNode *EC_BSIM3BgPtr;
    AccessNode *EC_BSIM3DPgPtr;
    AccessNode *EC_BSIM3SPgPtr;
    AccessNode *EC_BSIM3SPsPtr;
    AccessNode *EC_BSIM3DPbPtr;
    AccessNode *EC_BSIM3SPbPtr;
    AccessNode *EC_BSIM3SPdpPtr;

    AccessNode *EC_BSIM3QqPtr;
    AccessNode *EC_BSIM3QdpPtr;
    AccessNode *EC_BSIM3QgPtr;
    AccessNode *EC_BSIM3QspPtr;
    AccessNode *EC_BSIM3QbPtr;
    AccessNode *EC_BSIM3DPqPtr;
    AccessNode *EC_BSIM3GqPtr;
    AccessNode *EC_BSIM3SPqPtr;
    AccessNode *EC_BSIM3BqPtr;


    /* quick access to spmatrix node */
    AccessNode *G_BSIM3DdPtr;
    AccessNode *G_BSIM3GgPtr;
    AccessNode *G_BSIM3SsPtr;
    AccessNode *G_BSIM3BbPtr;
    AccessNode *G_BSIM3DPdpPtr;
    AccessNode *G_BSIM3SPspPtr;
    AccessNode *G_BSIM3DdpPtr;
    AccessNode *G_BSIM3GbPtr;
    AccessNode *G_BSIM3GdpPtr;
    AccessNode *G_BSIM3GspPtr;
    AccessNode *G_BSIM3SspPtr;
    AccessNode *G_BSIM3BdpPtr;
    AccessNode *G_BSIM3BspPtr;
    AccessNode *G_BSIM3DPspPtr;
    AccessNode *G_BSIM3DPdPtr;
    AccessNode *G_BSIM3BgPtr;
    AccessNode *G_BSIM3DPgPtr;
    AccessNode *G_BSIM3SPgPtr;
    AccessNode *G_BSIM3SPsPtr;
    AccessNode *G_BSIM3DPbPtr;
    AccessNode *G_BSIM3SPbPtr;
    AccessNode *G_BSIM3SPdpPtr;

    AccessNode *G_BSIM3QqPtr;
    AccessNode *G_BSIM3QdpPtr;
    AccessNode *G_BSIM3QgPtr;
    AccessNode *G_BSIM3QspPtr;
    AccessNode *G_BSIM3QbPtr;
    AccessNode *G_BSIM3DPqPtr;
    AccessNode *G_BSIM3GqPtr;
    AccessNode *G_BSIM3SPqPtr;
    AccessNode *G_BSIM3BqPtr;



    /* Store the internal states of BSIM3. 
       state0 is current state
       state1 is the previous state
       added by Shih-Hung */
    double *state0;
    double *state1;
    double *state2;
