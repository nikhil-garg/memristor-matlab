...
int BSIM3InstanceSetup(ModelInstance *instances, 
		       SPMatrix *stamp, 
		       SPMatrix *g_stamp, 
		       SPMatrix *c_stamp,
		       SPMatrix *ec_stamp)
{
    ModelInstance *insPtr;
    BSIM3model *model;
    BSIM3instance *here;

    /* loop through all the instances*/
    //for (here = model->BSIM3instances; here != NULL ; here=here->BSIM3nextInstance) 
    for (insPtr = instances; insPtr; insPtr = insPtr->next)
    {   
	here = insPtr->instance;
	model = insPtr->instance->BSIM3modPtr;

	//assign stamp matrix (C/h+G) to bsim3 model
	here->stamp = stamp;
	here->g_stamp = g_stamp;
	here->c_stamp = c_stamp;
	here->ec_stamp = ec_stamp;
	...
	/* allocate the space for the internal state. 
	   added by Shih-Hung. */
	here->state0 = (double *)malloc(sizeof(double) * BSIM3numStates);
	here->state1 = (double *)malloc(sizeof(double) * BSIM3numStates);
	here->state2 = (double *)malloc(sizeof(double) * BSIM3numStates);

	memset(here->state0, 0, sizeof(double) * BSIM3numStates);
	memset(here->state1, 0, sizeof(double) * BSIM3numStates);
	memset(here->state2, 0, sizeof(double) * BSIM3numStates);
	/* initial as zero */
	...
	/* consider no drain or source series resistance */
	...
	/* no consideration of internal charge node */
	...
	//    //    return(error);
        ...
        /* modified by Shih-Hung */
        /* macro to make elements with built in test for out of memory */
        #define TSTALLOC(mtx, ptr, x, y) \
	    if((here->ptr = GetElementAccessNode(mtx, here->x, here->y))==NULL){\
                return ERR_UNDEFINED;\
            }

        /* modified by Shih-Hung */
        TSTALLOC(here->stamp, BSIM3DdPtr, BSIM3dNode, BSIM3dNode)
        TSTALLOC(here->stamp, BSIM3GgPtr, BSIM3gNode, BSIM3gNode)
        TSTALLOC(here->stamp, BSIM3SsPtr, BSIM3sNode, BSIM3sNode)
        TSTALLOC(here->stamp, BSIM3BbPtr, BSIM3bNode, BSIM3bNode)
        TSTALLOC(here->stamp, BSIM3DPdpPtr, BSIM3dNodePrime, BSIM3dNodePrime)
        TSTALLOC(here->stamp, BSIM3SPspPtr, BSIM3sNodePrime, BSIM3sNodePrime)
        TSTALLOC(here->stamp, BSIM3DdpPtr, BSIM3dNode, BSIM3dNodePrime)
        TSTALLOC(here->stamp, BSIM3GbPtr, BSIM3gNode, BSIM3bNode)
        TSTALLOC(here->stamp, BSIM3GdpPtr, BSIM3gNode, BSIM3dNodePrime)
        TSTALLOC(here->stamp, BSIM3GspPtr, BSIM3gNode, BSIM3sNodePrime)
        TSTALLOC(here->stamp, BSIM3SspPtr, BSIM3sNode, BSIM3sNodePrime)
        TSTALLOC(here->stamp, BSIM3BdpPtr, BSIM3bNode, BSIM3dNodePrime)
        TSTALLOC(here->stamp, BSIM3BspPtr, BSIM3bNode, BSIM3sNodePrime)
        TSTALLOC(here->stamp, BSIM3DPspPtr, BSIM3dNodePrime, BSIM3sNodePrime)
        TSTALLOC(here->stamp, BSIM3DPdPtr, BSIM3dNodePrime, BSIM3dNode)
        TSTALLOC(here->stamp, BSIM3BgPtr, BSIM3bNode, BSIM3gNode)
        TSTALLOC(here->stamp, BSIM3DPgPtr, BSIM3dNodePrime, BSIM3gNode)
        TSTALLOC(here->stamp, BSIM3SPgPtr, BSIM3sNodePrime, BSIM3gNode)
        TSTALLOC(here->stamp, BSIM3SPsPtr, BSIM3sNodePrime, BSIM3sNode)
        TSTALLOC(here->stamp, BSIM3DPbPtr, BSIM3dNodePrime, BSIM3bNode)
        TSTALLOC(here->stamp, BSIM3SPbPtr, BSIM3sNodePrime, BSIM3bNode)
        TSTALLOC(here->stamp, BSIM3SPdpPtr, BSIM3sNodePrime, BSIM3dNodePrime)
    
        TSTALLOC(here->stamp, BSIM3QqPtr, BSIM3qNode, BSIM3qNode)
    
        TSTALLOC(here->stamp, BSIM3QdpPtr, BSIM3qNode, BSIM3dNodePrime)
        TSTALLOC(here->stamp, BSIM3QspPtr, BSIM3qNode, BSIM3sNodePrime)
        TSTALLOC(here->stamp, BSIM3QgPtr, BSIM3qNode, BSIM3gNode)
        TSTALLOC(here->stamp, BSIM3QbPtr, BSIM3qNode, BSIM3bNode)
        TSTALLOC(here->stamp, BSIM3DPqPtr, BSIM3dNodePrime, BSIM3qNode)
        TSTALLOC(here->stamp, BSIM3SPqPtr, BSIM3sNodePrime, BSIM3qNode)
        TSTALLOC(here->stamp, BSIM3GqPtr, BSIM3gNode, BSIM3qNode)
        TSTALLOC(here->stamp, BSIM3BqPtr, BSIM3bNode, BSIM3qNode)
    
    
        /* added by Shih-Hung */
	/* added entries for C matrix */
        TSTALLOC(here->c_stamp, C_BSIM3DdPtr, BSIM3dNode, BSIM3dNode)
        TSTALLOC(here->c_stamp, C_BSIM3GgPtr, BSIM3gNode, BSIM3gNode)
        TSTALLOC(here->c_stamp, C_BSIM3SsPtr, BSIM3sNode, BSIM3sNode)
        TSTALLOC(here->c_stamp, C_BSIM3BbPtr, BSIM3bNode, BSIM3bNode)
        TSTALLOC(here->c_stamp, C_BSIM3DPdpPtr, BSIM3dNodePrime, BSIM3dNodePrime)
        TSTALLOC(here->c_stamp, C_BSIM3SPspPtr, BSIM3sNodePrime, BSIM3sNodePrime)
        TSTALLOC(here->c_stamp, C_BSIM3DdpPtr, BSIM3dNode, BSIM3dNodePrime)
        TSTALLOC(here->c_stamp, C_BSIM3GbPtr, BSIM3gNode, BSIM3bNode)
        TSTALLOC(here->c_stamp, C_BSIM3GdpPtr, BSIM3gNode, BSIM3dNodePrime)
        TSTALLOC(here->c_stamp, C_BSIM3GspPtr, BSIM3gNode, BSIM3sNodePrime)
        TSTALLOC(here->c_stamp, C_BSIM3SspPtr, BSIM3sNode, BSIM3sNodePrime)
        TSTALLOC(here->c_stamp, C_BSIM3BdpPtr, BSIM3bNode, BSIM3dNodePrime)
        TSTALLOC(here->c_stamp, C_BSIM3BspPtr, BSIM3bNode, BSIM3sNodePrime)
        TSTALLOC(here->c_stamp, C_BSIM3DPspPtr, BSIM3dNodePrime, BSIM3sNodePrime)
        TSTALLOC(here->c_stamp, C_BSIM3DPdPtr, BSIM3dNodePrime, BSIM3dNode)
        TSTALLOC(here->c_stamp, C_BSIM3BgPtr, BSIM3bNode, BSIM3gNode)
        TSTALLOC(here->c_stamp, C_BSIM3DPgPtr, BSIM3dNodePrime, BSIM3gNode)
        TSTALLOC(here->c_stamp, C_BSIM3SPgPtr, BSIM3sNodePrime, BSIM3gNode)
        TSTALLOC(here->c_stamp, C_BSIM3SPsPtr, BSIM3sNodePrime, BSIM3sNode)
        TSTALLOC(here->c_stamp, C_BSIM3DPbPtr, BSIM3dNodePrime, BSIM3bNode)
        TSTALLOC(here->c_stamp, C_BSIM3SPbPtr, BSIM3sNodePrime, BSIM3bNode)
        TSTALLOC(here->c_stamp, C_BSIM3SPdpPtr, BSIM3sNodePrime, BSIM3dNodePrime)
    
        TSTALLOC(here->c_stamp, C_BSIM3QqPtr, BSIM3qNode, BSIM3qNode)
    
        TSTALLOC(here->c_stamp, C_BSIM3QdpPtr, BSIM3qNode, BSIM3dNodePrime)
        TSTALLOC(here->c_stamp, C_BSIM3QspPtr, BSIM3qNode, BSIM3sNodePrime)
        TSTALLOC(here->c_stamp, C_BSIM3QgPtr, BSIM3qNode, BSIM3gNode)
        TSTALLOC(here->c_stamp, C_BSIM3QbPtr, BSIM3qNode, BSIM3bNode)
        TSTALLOC(here->c_stamp, C_BSIM3DPqPtr, BSIM3dNodePrime, BSIM3qNode)
        TSTALLOC(here->c_stamp, C_BSIM3SPqPtr, BSIM3sNodePrime, BSIM3qNode)
        TSTALLOC(here->c_stamp, C_BSIM3GqPtr, BSIM3gNode, BSIM3qNode)
        TSTALLOC(here->c_stamp, C_BSIM3BqPtr, BSIM3bNode, BSIM3qNode)

	/* added entries for eC matrix */
        TSTALLOC(here->ec_stamp, EC_BSIM3DdPtr, BSIM3dNode, BSIM3dNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3GgPtr, BSIM3gNode, BSIM3gNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3SsPtr, BSIM3sNode, BSIM3sNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3BbPtr, BSIM3bNode, BSIM3bNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3DPdpPtr, BSIM3dNodePrime, BSIM3dNodePrime)
        TSTALLOC(here->ec_stamp, EC_BSIM3SPspPtr, BSIM3sNodePrime, BSIM3sNodePrime)
        TSTALLOC(here->ec_stamp, EC_BSIM3DdpPtr, BSIM3dNode, BSIM3dNodePrime)
        TSTALLOC(here->ec_stamp, EC_BSIM3GbPtr, BSIM3gNode, BSIM3bNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3GdpPtr, BSIM3gNode, BSIM3dNodePrime)
        TSTALLOC(here->ec_stamp, EC_BSIM3GspPtr, BSIM3gNode, BSIM3sNodePrime)
        TSTALLOC(here->ec_stamp, EC_BSIM3SspPtr, BSIM3sNode, BSIM3sNodePrime)
        TSTALLOC(here->ec_stamp, EC_BSIM3BdpPtr, BSIM3bNode, BSIM3dNodePrime)
        TSTALLOC(here->ec_stamp, EC_BSIM3BspPtr, BSIM3bNode, BSIM3sNodePrime)
        TSTALLOC(here->ec_stamp, EC_BSIM3DPspPtr, BSIM3dNodePrime, BSIM3sNodePrime)
        TSTALLOC(here->ec_stamp, EC_BSIM3DPdPtr, BSIM3dNodePrime, BSIM3dNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3BgPtr, BSIM3bNode, BSIM3gNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3DPgPtr, BSIM3dNodePrime, BSIM3gNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3SPgPtr, BSIM3sNodePrime, BSIM3gNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3SPsPtr, BSIM3sNodePrime, BSIM3sNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3DPbPtr, BSIM3dNodePrime, BSIM3bNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3SPbPtr, BSIM3sNodePrime, BSIM3bNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3SPdpPtr, BSIM3sNodePrime, BSIM3dNodePrime)
    
        TSTALLOC(here->ec_stamp, EC_BSIM3QqPtr, BSIM3qNode, BSIM3qNode)
    
        TSTALLOC(here->ec_stamp, EC_BSIM3QdpPtr, BSIM3qNode, BSIM3dNodePrime)
        TSTALLOC(here->ec_stamp, EC_BSIM3QspPtr, BSIM3qNode, BSIM3sNodePrime)
        TSTALLOC(here->ec_stamp, EC_BSIM3QgPtr, BSIM3qNode, BSIM3gNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3QbPtr, BSIM3qNode, BSIM3bNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3DPqPtr, BSIM3dNodePrime, BSIM3qNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3SPqPtr, BSIM3sNodePrime, BSIM3qNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3GqPtr, BSIM3gNode, BSIM3qNode)
        TSTALLOC(here->ec_stamp, EC_BSIM3BqPtr, BSIM3bNode, BSIM3qNode)

	/* added entries for G matrix */
        TSTALLOC(here->g_stamp, G_BSIM3DdPtr, BSIM3dNode, BSIM3dNode)
        TSTALLOC(here->g_stamp, G_BSIM3GgPtr, BSIM3gNode, BSIM3gNode)
        TSTALLOC(here->g_stamp, G_BSIM3SsPtr, BSIM3sNode, BSIM3sNode)
        TSTALLOC(here->g_stamp, G_BSIM3BbPtr, BSIM3bNode, BSIM3bNode)
        TSTALLOC(here->g_stamp, G_BSIM3DPdpPtr, BSIM3dNodePrime, BSIM3dNodePrime)
        TSTALLOC(here->g_stamp, G_BSIM3SPspPtr, BSIM3sNodePrime, BSIM3sNodePrime)
        TSTALLOC(here->g_stamp, G_BSIM3DdpPtr, BSIM3dNode, BSIM3dNodePrime)
        TSTALLOC(here->g_stamp, G_BSIM3GbPtr, BSIM3gNode, BSIM3bNode)
        TSTALLOC(here->g_stamp, G_BSIM3GdpPtr, BSIM3gNode, BSIM3dNodePrime)
        TSTALLOC(here->g_stamp, G_BSIM3GspPtr, BSIM3gNode, BSIM3sNodePrime)
        TSTALLOC(here->g_stamp, G_BSIM3SspPtr, BSIM3sNode, BSIM3sNodePrime)
        TSTALLOC(here->g_stamp, G_BSIM3BdpPtr, BSIM3bNode, BSIM3dNodePrime)
        TSTALLOC(here->g_stamp, G_BSIM3BspPtr, BSIM3bNode, BSIM3sNodePrime)
        TSTALLOC(here->g_stamp, G_BSIM3DPspPtr, BSIM3dNodePrime, BSIM3sNodePrime)
        TSTALLOC(here->g_stamp, G_BSIM3DPdPtr, BSIM3dNodePrime, BSIM3dNode)
        TSTALLOC(here->g_stamp, G_BSIM3BgPtr, BSIM3bNode, BSIM3gNode)
        TSTALLOC(here->g_stamp, G_BSIM3DPgPtr, BSIM3dNodePrime, BSIM3gNode)
        TSTALLOC(here->g_stamp, G_BSIM3SPgPtr, BSIM3sNodePrime, BSIM3gNode)
        TSTALLOC(here->g_stamp, G_BSIM3SPsPtr, BSIM3sNodePrime, BSIM3sNode)
        TSTALLOC(here->g_stamp, G_BSIM3DPbPtr, BSIM3dNodePrime, BSIM3bNode)
        TSTALLOC(here->g_stamp, G_BSIM3SPbPtr, BSIM3sNodePrime, BSIM3bNode)
        TSTALLOC(here->g_stamp, G_BSIM3SPdpPtr, BSIM3sNodePrime, BSIM3dNodePrime)
    
        TSTALLOC(here->g_stamp, G_BSIM3QqPtr, BSIM3qNode, BSIM3qNode)
    
        TSTALLOC(here->g_stamp, G_BSIM3QdpPtr, BSIM3qNode, BSIM3dNodePrime)
        TSTALLOC(here->g_stamp, G_BSIM3QspPtr, BSIM3qNode, BSIM3sNodePrime)
        TSTALLOC(here->g_stamp, G_BSIM3QgPtr, BSIM3qNode, BSIM3gNode)
        TSTALLOC(here->g_stamp, G_BSIM3QbPtr, BSIM3qNode, BSIM3bNode)
        TSTALLOC(here->g_stamp, G_BSIM3DPqPtr, BSIM3dNodePrime, BSIM3qNode)
        TSTALLOC(here->g_stamp, G_BSIM3SPqPtr, BSIM3sNodePrime, BSIM3qNode)
        TSTALLOC(here->g_stamp, G_BSIM3GqPtr, BSIM3gNode, BSIM3qNode)
        TSTALLOC(here->g_stamp, G_BSIM3BqPtr, BSIM3bNode, BSIM3qNode)
    }
...
int BSIM3ModelSetup(ModelCard *models)
{
    ...
    //CKTnode *tmpNode;
    //IFuid tmpName;
    //SMPmatrix *C_matrix = ckt->CKTCmatrix;	/* Added by Shih-Hung */
    //int total_ins = 0;		        /* Added by Shih-Hung */

    /*  loop through all the BSIM3 device models */
    for( modelPtr = models; modelPtr; modelPtr = modelPtr->next) 
    {
	...
	/* Cross-term dependence */
	    ...
	    model->BSIM3tnom = 25; //ckt->CKTnomTemp; 
/*        else
	...
	if (!model->BSIM3cfGiven)
            model->BSIM3cf = 2.0 * EPSOX / PI * log(1.0 + 0.4e-6 / model->BSIM3tox);
