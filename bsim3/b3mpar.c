...
BSIM3model *mod)
{
	...
	/* Cross-term dependence */
        ...
        case  BSIM3_MOD_NOIA :
            mod->BSIM3oxideTrapDensityA = value;
            mod->BSIM3oxideTrapDensityAGiven = TRUE;
            break;
        case  BSIM3_MOD_NOIB :
            mod->BSIM3oxideTrapDensityB = value;
            mod->BSIM3oxideTrapDensityBGiven = TRUE;
            break;
        case  BSIM3_MOD_NOIC :
            mod->BSIM3oxideTrapDensityC = value;
