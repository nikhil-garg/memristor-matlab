...
%   (optional) reiter: re-iterate with smaller step size due to bigger LTE
%   or not converge
% Outputs:
...
function [result tot_it next_f dfdt LTE] = MEXP_NR_AC_Analysis(SimParam, init_values, pre_voltage, pre_pre_voltage, ...
    ...
    [spm_c spm_g dummy f spm_ec] = BSIM3Eval( SimParam.instance, [0; voltage], step_size, 'tran', first_time, reiter);
