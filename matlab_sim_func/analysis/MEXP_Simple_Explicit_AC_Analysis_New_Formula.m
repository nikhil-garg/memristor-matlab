...
function [result tot_it converged dx] = MEXP_Simple_Explicit_AC_Analysis_New_Formula(SimParam, init_value, pre_voltage, ...
    ...
    pre_f = f;
    alpha = step_size/10;
    [Ctmp Gtmp v_tmp] = ConstructOneMEXP(C, SimParam.Gl, SimParam.B, v, step_size, alpha, input, pre_input, pre_f, f);
