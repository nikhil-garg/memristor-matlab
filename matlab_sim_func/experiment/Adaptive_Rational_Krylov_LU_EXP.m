...
function [H V beta m expH err] = Adaptive_Rational_Krylov_LU_EXP( SimParam, L, U, P, Q, C, W, Ij, ep, h, v, scale)
    ...
    for j = 1:m
        ...
        %precondition 1 reduced version
        ...
        %check the error 
        [expH err] = rational_EXP0_EXP(H(1:j, 1:j), eye(j, 1), scale);
